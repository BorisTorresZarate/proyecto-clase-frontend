...
export function Login() {
    return (
        <div className='relative w-[750px] h-[450px] bg-transparent border-2 border-solid border-[#0ef] overflow-hidden '>
            ...
            <span></span>
            <div className='absolute top-0 w-1/2 h-full flex flex-col justify-center left-0 px-10 '>
